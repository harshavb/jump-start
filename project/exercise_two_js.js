...
function drawInstructions()
{
	...
	textSize(48);
	rectMode(CENTER);
	text('In this exercise, colored circles will appear on your screen. Click on a circle (or use Z and X) and match it with its colored pair.', windowWidth/2, 4 * windowHeight/9, windowWidth/2, windowHeight/2);
	rectMode(CORNER);
