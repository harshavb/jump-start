...
function drawInstructions()
{
	...
	textSize(48);
	rectMode(CENTER);
	text('In this exercise, a bunch of floating circles will move around your screen. Simply click on the circles before the grow too big! (Or use Z and X)', windowWidth/2, 4 * windowHeight/9, windowWidth/4, windowHeight);
	rectMode(CORNER);
