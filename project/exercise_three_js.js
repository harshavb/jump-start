...
function drawInstructions()
{
	...
	textSize(48);
	rectMode(CENTER);
	text('In this exercise, various shapes will appear on your screen. Trace the edges without losing 3 strikes.', windowWidth/2, 4 * windowHeight/9, windowWidth/3, windowHeight);
	rectMode(CORNER);
